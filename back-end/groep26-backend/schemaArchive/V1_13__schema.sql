...
DROP TABLE IF EXISTS wallets, rents, rentals, cars, users, roles, notifications, Notification,notifications_users CASCADE;
...
INSERT INTO users (username, password, email, phone_number, given_verification_code, verified, experation_date, banned, wallet_id,role_id)
VALUES ('renter26', '$2a$12$m.VOPHE1/nQ/qfFtmff1e.SheHO4e93Df9Gq.H..ZcHN9m0bE0tbu','renter26.softeng@gmail.com','0491257846', 123456, true, '2024-09-10', false, 2,2);
...
INSERT INTO users (username, password, email, phone_number, given_verification_code, verified, experation_date, banned, wallet_id,role_id)
VALUES ('owner26', '$2a$12$m.VOPHE1/nQ/qfFtmff1e.SheHO4e93Df9Gq.H..ZcHN9m0bE0tbu','owner26.softeng@gmail.com','0491257847', 123456, true, '2024-09-10', false, 3,1);
